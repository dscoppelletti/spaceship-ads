...
import it.scoppelletti.spaceship.ads.databinding.ConsentUnderageFragmentBinding
...
public class ConsentUnderageFragment : Fragment(
        R.layout.it_scoppelletti_ads_consentunderage_fragment
) {
    private lateinit var activityModel: ConsentViewModel
    private lateinit var viewModel: ConsentFragmentViewModel
    private lateinit var navController: NavController
    private val binding by viewBinding(ConsentUnderageFragmentBinding::bind)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.cmdAgree.setOnClickListener {
            activityModel.action(
                    ConsentCommand.SaveData(ConsentStatus.UNDER_AGE_OF_CONSENT))
        }
